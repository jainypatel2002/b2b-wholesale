    ...
    return (
        <div className="md:hidden">
            ...
            {isMounted && isOpen && createPortal(
                <>
                    <div
                        className="fixed inset-0 z-[9998] bg-slate-950/40 backdrop-blur-sm md:hidden"
                        aria-hidden="true"
                        onClick={() => setIsOpen(false)}
                    />

                    <div
                        className="fixed inset-y-0 left-0 z-[9999] h-[100dvh] w-[min(90vw,360px)] border-r border-white/70 bg-white/95 shadow-2xl backdrop-blur-xl md:hidden"
                    ...
                    >
                        <div className="flex h-[100dvh] min-h-0 flex-col">
                            ...
                            <div className="flex-1 overflow-y-auto px-3 py-4 pb-[calc(env(safe-area-inset-bottom)+72px)]">
