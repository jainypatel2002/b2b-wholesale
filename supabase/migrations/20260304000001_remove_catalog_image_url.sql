-- 20260304_remove_catalog_image_url.sql
-- HOTFIX: Remove the non-existent `p.image_url` column from `get_vendor_catalog_prices` which caused another 500 query error in the vendor catalog.
